# 按照阿里提的标准计算错误率
# 这个文件是其他参赛队伍的一位同学写的，在此表示感谢，我也说不出姓名，他在阿里技术圈开源的代码


import  numpy as np
import  cv2
GT_FILE = './results_gt/fashionAI_key_points_test_b_answer_20180426.csv'  # 真值文件
PRED_FILE = './ensembled_b_no_add1.csv' # 预测的文件
