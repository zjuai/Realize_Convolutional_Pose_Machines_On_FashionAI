class Valid_FLAGS(object):
    # run test use
    test_img_directory = '/home/lzhpc/home/gu/r2_test_b/'
    test_data_file = '/home/lzhpc/home/gu/r2_test_b/r2_test_b_2.csv'
    processed_testimg_directory = './preprocess/processed_r2_b'
    model_load_dir = './logs_and_weights_add_occlusion_and_fpn_total_dataset'
    normalize_img = True
    if_show = False
    if_save = False
    total_num_joints = 24
