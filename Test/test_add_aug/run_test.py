...
def main(argv):
    ...
    suffix_path = 'r2_b_fpn_43w_no_add1_part_1'
    ...
    with tf.Session() as sess:
        ...
        while valid_iter < valid_num:
            ...
            print('r2_test_b_part_1_{}:\tvalid_iter'.format(ckpt), valid_iter)
...
def write2csv(total_joints_coord_set):
    with open('r2_test_b_43w_no_add1_part_1.csv', 'w') as single_csv:
